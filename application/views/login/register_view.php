...
<div class = "login column">
    ...
    <?php echo form_open(base_url() . 'login/validateregister');?>
     ...
     <p><label>Firstname</label><input type="text" name="firstname"class = "form square" /><span><?php echo form_error('firstname'); ?></span></p></p>
     <p><label>Middlename</label><input type="text" name="middlename" class = "form square"/><span><?php echo form_error('middlename'); ?></span></p></p>
     <p><label>Lastname</label><input type="text" name="lastname" class = "form square"/><span><?php echo form_error('lastname'); ?></span></p></p>
     <p><label>Contact Number</label><input type="text" name="contact_number" class = "form square" /><span><?php echo form_error('contact_number'); ?></span></p></p>
